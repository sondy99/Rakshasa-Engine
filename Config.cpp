...
void Config::AddGeometryType(const char * name, GeometryType geometryType) const
{
	writer->String(name);
...
GeometryType Config::GetGeometryType(const char * name, rapidjson::Value & value) const
{
	const char* stringComponentType = value[name].GetString();
